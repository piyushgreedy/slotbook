...
class Scheduler extends Component {
  ...
  componentDidMount() {
    ...
    axios.get("http://localhost:3000/getTimeBooked?bookids="+this.finalBookedArray.concat(this.initialBookedTime)+":::"+currentDate+":::"+currentPC+":::1"))
    .then((response) => {
  ...
  bookTimeSlot = (currentPC,currentDate)=>{
    ...
    axios.get("http://localhost:3000/bookTimeSlot?bookids="+this.finalBookedArray.concat(this.initialBookedTime)+":::"+currentDate+":::"+currentPC+":::1")
    .then((response) => {
        console.log(response.data);
