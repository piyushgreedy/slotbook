...
class Scheduler extends Component {
  ...
  componentDidMount() {
    ...
    //         console.log("2019-10-05T"+ (parseInt(splitArr[i])).toString() +":00:00")
    //         console.log("2019-10-0T"+ (parseInt(splitArr[i])+1).toString() +":00:00")
    //         var eventObj={
    //             id: Math.floor(Math.random() * 1000000000000),
    //             text: "I am Booked",
    //             start: "2019-10-05T"+ (parseInt(splitArr[i])).toString() +":00:00",
    ...
    this.setState({
      ...
      events: [
        ...
        {
          "start": "2019-10-05T03:00:00",
          "end": "2019-10-05T07:00:00",
          "id": "eea1a534-bf9d-2296-61e0-abfcbed21a91",
          "resource": "R2",
          "text": "Event 1"
        },
        {
          "start": "2019-10-05T07:00:00",
          "end": "2019-10-05T14:00:00",
          "id": "70c273b3-4f27-a243-f3a6-07d4dd110baa",
          "resource": "R1",
          "text": "Event 1"
        }
      ]
                      ...
                      <Tab.Content>
                        ...
                        <Tab.Pane eventKey="second">
                          <DropdownButton id="dropdown-basic-button2" variant="success" title="Select Computer Category">
                            <Dropdown.Item href="#/action4">PC 1</Dropdown.Item>
                            <Dropdown.Item href="#/action5">PC 2</Dropdown.Item>
                          </DropdownButton>
                        </Tab.Pane>
                        <Tab.Pane eventKey="third">
                          <DropdownButton id="dropdown-basic-button3" variant="success" title="Select Computer Category">
                            <Dropdown.Item href="#/action6">PC 1</Dropdown.Item>
                            <Dropdown.Item href="#/action7">PC 2</Dropdown.Item>
                            <Dropdown.Item href="#/action8">PC 3</Dropdown.Item>
                          </DropdownButton>
                        </Tab.Pane>
                        <Tab.Pane eventKey="fourth">
                        <DropdownButton id="dropdown-basic-button4" variant="success" title="Select Computer Category">
                            <Dropdown.Item href="#/action">PC 1</Dropdown.Item>
                            <Dropdown.Item href="#/action-2">PC 2</Dropdown.Item>
                            <Dropdown.Item href="#/action-3">PC 3</Dropdown.Item>
                          </DropdownButton>
                        </Tab.Pane>
                      </Tab.Content>
                    </Col>
