    ...
    return (
      <div className="schedule-time">
        ...
        <Container>
          ...
          <a target="_blank" href="./text.txt" download="bh.txt">Connnection</a>
          <form method="POST" action="https://testbucketingaas.s3.amazonaws.com/text.txt">
   <button onclick="window.open('https://testbucketingaas.s3.amazonaws.com/text.txt')" type="submit">Download!</button>
</form>
        </Container>
