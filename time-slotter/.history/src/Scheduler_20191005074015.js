                    ...
                    <Col sm={9}>
                      <Tab.Content>
                        <Tab.Pane eventKey="first">
                          <DropdownButton id="dropdown-basic-button" variant="success"  title="Select Computer Category">
                        ...
                        <DropdownButton id="dropdown-basic-button4" variant="success" title="Select Computer Category">
                            <Dropdown.Item href="#/action9">PC 1</Dropdown.Item>
                            <Dropdown.Item href="#/action10">PC 2</Dropdown.Item>
                            <Dropdown.Item href="#/action11">PC 3</Dropdown.Item>
                        </DropdownButton>
                        </Tab.Pane>
                      </Tab.Content>
                    </Col>
