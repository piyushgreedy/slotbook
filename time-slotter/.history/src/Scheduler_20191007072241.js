  ...
  getBookedTimeSlot=(currentDate,currentPC)=>{
    ...
    .then((response) => {
        ...
        for(var i=0;i< splitArr.length;i++){
            ...
            console.log("2019-10-+"+"T"+ splitArr[i] +":00:00")
            console.log("2019-10-07T"+ (parseInt(splitArr[i])+1).toString() +":00:00")
            var eventObj={
                id: Math.floor(Math.random() * 1000000000000),
                text: "I am Booked",
                start: "2019-10-07T"+ splitArr[i] +":00:00",
                end: "2019-10-07T"+ (parseInt(splitArr[i])+1).toString() +":00:00",
                resource: "A"
            }
